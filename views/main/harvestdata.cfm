...
<div id="app">
    ...
    <div class="row m-0">
        ...
        <div class="col-2">
            <input type="text" class="form-control m-2" id="filterData" placeholder="Filter by..." v-model="filterBy" v-on:keyup.enter="filterData">
        </div>
        <div class="col-2">
                                        ...
                                        buttons: [
                                            {
                                                ...
                                                class:"ui-button ui-corner-all ui-widget",
                                                click: function() {
                                                    oldRowData = JSON.stringify(ui.rowData);
                                                    var newRowData = {
                                                        Date: $('#Date').val(),
                                                        JobCode: $('#JobCode').val(),
                                                        Crew: $('#Crew').val(),
